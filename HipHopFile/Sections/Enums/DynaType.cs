namespace HipHopFile
{
    public enum DynaType : uint
    {
        ...
        Unknown_2CD29541 = 0x2CD29541,
        Unknown_4EE03B24 = 0x4EE03B24,
        Unknown_9F234F8E = 0x9F234F8E,
        Unknown_460F4FB2 = 0x460F4FB2,
        Unknown_2743B85C = 0x2743B85C,
        Unknown_A072A4DA = 0xA072A4DA,
        Unknown_AD7CB421 = 0xAD7CB421,
        Unknown_C6C76EEE = 0xC6C76EEE,
        Unknown_CDB57387 = 0xCDB57387,
        Unknown_CF21DB89 = 0xCF21DB89,
        Unknown_E5D82D97 = 0xE5D82D97,
        Unknown_E2301EA9 = 0xE2301EA9,
        Unknown_EBC04E7B = 0xEBC04E7B,
        Unknown_FC2951C1 = 0xFC2951C1
    }

    public enum DynaType_Alphabetical : uint
    {
        Null,
        audio__conversation,
        camera__binary_poi,
        camera__preset,
        camera__transition_path,
        camera__transition_time,
        Checkpoint,
        effect__BossBrain,
        effect__Flamethrower,
        effect__grass,
        effect__light,
        effect__LightEffectFlicker,
        effect__LightEffectStrobe,
        effect__Lightning,
        Effect__particle_generator,
        effect__Rumble,
        effect__RumbleBoxEmitter,
        effect__RumbleSphericalEmitter,
        effect__ScreenFade,
        effect__ScreenWarp,
        effect__smoke_emitter,
        effect__spark_emitter,
        effect__Splash,
        effect__spotlight,
        effect__uber_laser,
        effect__Waterhose,
        effect__water_body,
        Enemy__SB,
        Enemy__SB__BucketOTron,
        Enemy__SB__CastNCrew,
        Enemy__SB__Critter,
        Enemy__SB__Dennis,
        Enemy__SB__FrogFish,
        Enemy__SB__Mindy,
        Enemy__SB__Neptune,
        Enemy__SB__Standard,
        Enemy__SB__SupplyCrate,
        Enemy__SB__Turret,
        game_object__BoulderGenerator,
        game_object__bullet_mark,
        game_object__bullet_time,
        game_object__bungee_drop,
        game_object__bungee_hook,
        game_object__BusStop,
        game_object__camera_param_asset,
        game_object__Camera_Tweak,
        game_object__dash_camera_spline,
        game_object__flame_emitter,
        game_object__Flythrough,
        game_object__FreezableObject,
        game_object__Grapple,
        game_object__Hangable,
        game_object__IN_Pickup,
        game_object__laser_beam,
        game_object__NPCSettings​,
        game_object__RaceTimer,
        game_object__rband_camera_asset,
        game_object__Ring,
        game_object__RingControl,
        game_object__RubbleGenerator,
        game_object__talk_box,
        game_object__task_box,
        game_object__Taxi​,
        game_object__Teleport,
        game_object__text_box,
        game_object__train_car,
        game_object__train_junction,
        game_object__Turret,
        game_object__Vent,
        game_object__VentType,
        hud__image,
        hud__meter__font,
        hud__meter__unit,
        hud__model,
        hud__text,
        Incredibles__Icon,
        interaction__IceBridge,
        interaction__Launch,
        interaction__Lift,
        interaction__SwitchLever,
        interaction__Turn,
        Interest_Pointer,
        JSPExtraData,
        logic__FunctionGenerator,
        logic__reference,
        npc__CoverPoint,
        npc__group,
        npc__NPC_Custom_AV,
